...
export default function Signup() {
    ...
    const handleSubmit = ()=>{
        ...
        if(err.length > 0){
            ...
            axios.post('http://127.0.0.1:8000/eventAPI/admins/', form_data, {
                headers: {
    ...
    <div>
        <div className='bg-gray-200 w-screen h-screen flex flex-col justify-center items-center'>
            ...
            <div className='flex flex-col gap-6 w-2/5 p-20 items-end'>
                ...
                <div onClick={handleSubmit} className='p-3 bg-blue-400 rounded-md text-lg font-semibold w-1/2 flex justify-end text-gray-200 cursor-pointer hover:bg-blue-500 transition-all duration-300'>
                    signup
                </div>
